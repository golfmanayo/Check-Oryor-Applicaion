...
class Oryor {
    ...
    private val foodPattern: String = "[0-9]{2}-[0-9]-[0-9]{5}-[0-9]-[0-9]{4}"
    private val medicinePattern: String = "[0-9]{0,1}[ABCDEFGHKLMN][0-9]{1,4}\\/[0-9]{2}"
    private val cosmeticsPattern: String = "[0-9]{2}-[0-9]-[0-9]{10}|[0-9]{2}-[0-9]-[0-9]{7}"
    private val medicalInsPattern: String = "[ผน]\\.[0-9]{2}/[0-9]{4}"
    private val dangerPattern: String = "วอส\\.[0-9]{2}/[0-9]{4}"
